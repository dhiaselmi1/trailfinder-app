...
export class DealsComponent implements OnInit {
    ...
    sectionTitle = [
        {
            title: `Nos Articles Best-Seller`,
            paragraph: `Notre sélection de produits populaires combine qualité, style et fonctionnalité pour répondre à vos besoins quotidiens.`
        }
    ]
    singleDealsBox = [
        {
